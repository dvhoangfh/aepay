...
class SendTelegramOrderCreated
{
    ...
    public function handle(BytePayOrderCreated $payload)
    {
        $order = BytePayOrder::with(['customer', 'package'])->where('order_id', $payload->payload)->first();
        try {
