      ...
      <div class="detail-plan" style="margin-top: 0; margin-bottom: 0">
        <div class="left">
          ...
          <template v-else>
            ...
            <div v-if="settings.is_enable_wordpress_paycec" style="margin-top: 20px" class="wp-button-container" @click="onCheckoutWp('paycec')">
              <span class="text">Visa or Credit Card By</span>
              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                   width="111px" height="33px" viewBox="0.7 -2.712 111 33" enable-background="new 0.7 -2.712 111 33" xml:space="preserve">
<g>
	<g>
