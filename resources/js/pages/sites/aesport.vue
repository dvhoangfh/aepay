      ...
      <div class="detail-plan" style="margin-top: 0; margin-bottom: 0">
        <div class="left">
          ...
          <template v-else>
            ...
            <template v-if="is_enable_wordpress">
              <div style="margin-top: 20px" class="wp-button-container" @click="onCheckoutWp('paypal')">
              ...
              <div class="cc-button-container" @click="onCheckoutWp('stripe')">
